...
function Toolbar() {
  ...
  return (
    <div className=" grid gap-16 w-full h-fit p-0 z-10">
      {/* navigation */}
      <div class="shadow-lg fixed z-40 top-0  bg-white w-full">
        <div class="flex  gap-10 flex-row h-24 justify-between  text-black p-5 s-2 items-center ">
          <Link to='/'  class="font-bold pl-10 text-2xl cursor-pointer">
            <svg
          ...
          <div class="flex gap-10 cursor-pointer">
            <button class="border-2 border-[#d9d5d4] text-black w-36 bg-[#d9d5d4] rounded-sm font-semibold text-[18px] p-2 font-serif hover:bg-gray-200">
              CONTACT
            </button>
            <div className="border-2 flex gap-2 justify-between items-center font-serif w-34 h-8 mt-2 rounded-sm p-[4px]">
              <div>
                ...
                >
                  ...
                  >
                    <path d="M30 42.773L31.206 42l.658 1.272l1.43-.066l-.066 1.431l1.272.657l-.773 1.206l.773 1.206l-1.272.657l.066 1.431l-1.43-.066L31.206 51L30 50.227L28.794 51l-.657-1.272l-1.431.066l.066-1.431l-1.272-.657l.773-1.206l-.773-1.206l1.272-.657l-.066-1.431l1.431.066l.657-1.272z" />
                  ...
                  <g stroke-linecap="round" stroke-linejoin="round">
                    <path fill="#d22f27" d="M50 55H22V17l28 20H33z" />
                    <path
                      fill="#fff"
                      stroke="#fff"
                      d="M30 42.773L31.206 42l.658 1.272l1.43-.066l-.066 1.431l1.272.657l-.773 1.206l.773 1.206l-1.272.657l.066 1.431l-1.43-.066L31.206 51L30 50.227L28.794 51l-.657-1.272l-1.431.066l.066-1.431l-1.272-.657l.773-1.206l-.773-1.206l1.272-.657l-.066-1.431l1.431.066l.657-1.272z"
                    />
                    <circle cx="30" cy="30" r="2" fill="#fff" stroke="#fff" />
                    <path
                      fill="none"
                      stroke="#fff"
                      stroke-width="1.5"
