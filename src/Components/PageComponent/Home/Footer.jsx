...
const Footer = () => {
    return (
        <div className="bg-[#f0eded]  h-[450px] mt-[-120px]   ">
            <div className=" grid grid-row-2 gap-24  h-fit w-10/12 mx-auto mt-10 ">
                <div className="flex gap-14">
                    <div className="grid  justify-between items-center ">
                        ...
                        <div className="flex items-center w-[244px]  h-10 p-5 text-white bg-black ">
                    ...
                    <div className="grid grid-cols-4 w-full ">
                        ...
                        <div className="grid grid-cols-3 h-fit gap-64 w-[650px]">
                            ...
                            <div className=" mt-14 w-full h-fit bg-white ">
                                <div className="grid ">
                                    <div className="flex items-center gap-4 ">
                                        <div>
                                            ...
                                            >
                                                <path
                                                    fill="#22408b"
                                                    d="M27.796 19L8 5v26h19.796L15.918 19z"
                                                />
                                                <path
                                                    fill="#dd2f45"
                                                    d="M25 18L9 7.196V30h16L13.574 18z"
                                                />
                                                <path
                                                    fill="#fff"
